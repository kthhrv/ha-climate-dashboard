 ...
 */
const R = globalThis, q = R.ShadowRoot && (R.ShadyCSS === void 0 || R.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, V = Symbol(), Z = /* @__PURE__ */ new WeakMap();
let ot = class {
  constructor(t, e, s) {
...
const ct = (r) => new ot(typeof r == "string" ? r : r + "", void 0, V), dt = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: ut, defineProperty: $t, getOwnPropertyDescriptor: _t, getOwnPropertyNames: ft, getOwnPropertySymbols: yt, getPrototypeOf: At } = Object, f = globalThis, G = f.trustedTypes, mt = G ? G.emptyScript : "", L = f.reactiveElementPolyfillSupport, C = (r, t) => r, D = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? mt : null;
      break;
  ...
  return e;
} }, J = (r, t) => !ut(r, t), Q = { attribute: !0, type: String, converter: D, reflect: !1, useDefault: !1, hasChanged: J };
...
let b = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(C("properties"))) {
      const e = this.properties, s = [...ft(e), ...yt(e)];
...
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[C("elementProperties")] = /* @__PURE__ */ new Map(), b[C("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: b }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const P = globalThis, j = P.trustedTypes, X = j ? j.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, nt = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, ht = "?" + _, gt = `<${ht}>`, g = document, x = () => g.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", K = Array.isArray, vt = (r) => K(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", B = `[ 	
\f\r]`, w = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Y = /-->/g, tt = />/g, y = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), et = /'/g, st = /"/g, at = /^(?:script|style|textarea|title)$/i, bt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), Et = bt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), it = /* @__PURE__ */ new WeakMap(), A = g.createTreeWalker(g, 129);
function lt(r, t) {
...
const St = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === w ? p[1] === "!--" ? o = Y : p[1] !== void 0 ? o = tt : p[2] !== void 0 ? (at.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = y) : p[3] !== void 0 && (o = y) : o === y ? p[0] === ">" ? (o = i ?? w, l = -1) : p[1] === void 0 ? l = -2 : (l = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? y : p[3] === '"' ? st : et) : o === st || o === et ? o = y : o === Y || o === tt ? o = w : (o = y, i = void 0);
    const $ = o === y && r[a + 1].startsWith("/>") ? " " : "";
    n += o === w ? h + gt : l >= 0 ? (s.push(c), h.slice(0, l) + nt + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = A.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(nt)) {
          ...
          h.push({ type: 1, index: n, name: N[2], strings: $, ctor: N[1] === "." ? Ct : N[1] === "?" ? Pt : N[1] === "@" ? Ot : k }), i.removeAttribute(l);
...
class M {
  ...
  $(t) {
    var n;
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = H.createElement(lt(s.h, s.h[0]), this.options)), s);
  ...
  _$AC(t) {
    ...
    return e === void 0 && it.set(t.strings, e = new H(t)), e;
  }
  k(t) {
    K(this._$AH) || (this._$AH = [], this._$AR());
    const e = this._$AH;
    let s, i = 0;
    for (const n of t) i === e.length ? e.push(s = new M(this.O(x()), this.O(x()), this, this.options)) : s = e[i], s._$AI(n), i++;
...
I == null || I(H, M), (P.litHtmlVersions ?? (P.litHtmlVersions = [])).push("3.3.1");
const Ut = (r, t, e) => {
...
var rt;
O._$litElement$ = !0, O.finalized = !0, (rt = m.litElementHydrateSupport) == null || rt.call(m, { LitElement: O });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Mt = { attribute: !0, type: String, converter: D, reflect: !1, hasChanged: J }, Tt = (r = Mt, t, e) => {
...
var Nt = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, T = (r, t, e, s) => {
