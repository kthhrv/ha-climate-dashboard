...
let Oe = class {
  ...
  get styleSheet() {
    ...
    if (_e && e === void 0) {
      ...
      o && (e = ve.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), o && ve.set(t, e));
    }
    return e;
  }
  toString() {
...
const Ne = (s) => new Oe(typeof s == "string" ? s : s + "", void 0, me), I = (s, ...e) => {
  ...
  if (_e) s.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
    ...
    const o = document.createElement("style"), i = ee.litNonce;
    i !== void 0 && o.setAttribute("nonce", i), o.textContent = t.cssText, s.appendChild(o);
  }
}, be = _e ? (s) => s : (s) => s instanceof CSSStyleSheet ? ((e) => {
  let t = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: je, defineProperty: He, getOwnPropertyDescriptor: Le, getOwnPropertyNames: Re, getOwnPropertySymbols: Ze, getPrototypeOf: qe } = Object, C = globalThis, ye = C.trustedTypes, We = ye ? ye.emptyScript : "", ce = C.reactiveElementPolyfillSupport, F = (s, e) => s, te = { toAttribute(s, e) {
  switch (e) {
    case Boolean:
      s = s ? We : null;
      break;
  ...
  return t;
} }, ge = (s, e) => !je(s, e), $e = { attribute: !0, type: String, converter: te, reflect: !1, useDefault: !1, hasChanged: ge };
...
let B = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(F("properties"))) {
      const t = this.properties, o = [...Re(t), ...Ze(t)];
  ...
  _$ET(e, t) {
    ...
    if (i !== void 0 && o.reflect === !0) {
      const n = (((r = o.converter) == null ? void 0 : r.toAttribute) !== void 0 ? o.converter : te).toAttribute(t, o.type);
  ...
  _$AK(e, t) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const d = o.getPropertyOptions(i), a = typeof d.converter == "function" ? { fromAttribute: d.converter } : ((r = d.converter) == null ? void 0 : r.fromAttribute) !== void 0 ? d.converter : te;
      this._$Em = i;
  ...
  requestUpdate(e, t, o) {
    ...
    if (e !== void 0) {
      ...
      if (o ?? (o = r.getPropertyOptions(e)), !((o.hasChanged ?? ge)(n, t) || o.useDefault && o.reflect && n === ((i = this._$Ej) == null ? void 0 : i.get(e)) && !this.hasAttribute(r._$Eu(e, o)))) return;
      this.C(e, t, o);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (i.size > 0) for (const [r, n] of i) {
        const { wrapped: d } = n, a = this[r];
        d !== !0 || this._$AL.has(r) || a === void 0 || this.C(r, void 0, n, a);
      }
    }
    let e = !1;
    const t = this._$AL;
...
B.elementStyles = [], B.shadowRootOptions = { mode: "open" }, B[F("elementProperties")] = /* @__PURE__ */ new Map(), B[F("finalized")] = /* @__PURE__ */ new Map(), ce == null || ce({ ReactiveElement: B }), (C.reactiveElementVersions ?? (C.reactiveElementVersions = [])).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const J = globalThis, ie = J.trustedTypes, xe = ie ? ie.createPolicy("lit-html", { createHTML: (s) => s }) : void 0, Pe = "$lit$", k = `lit$${Math.random().toFixed(9).slice(2)}$`, De = "?" + k, Ve = `<${De}>`, T = document, K = () => T.createComment(""), G = (s) => s === null || typeof s != "object" && typeof s != "function", fe = Array.isArray, Fe = (s) => fe(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function", he = `[ 	
\f\r]`, V = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, we = /-->/g, Se = />/g, O = RegExp(`>|${he}(?:([^\\s"'>=/]+)(${he}*=${he}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Ae = /'/g, ke = /"/g, Te = /^(?:script|style|textarea|title)$/i, Je = (s) => (e, ...t) => ({ _$litType$: s, strings: e, values: t }), l = Je(1), j = Symbol.for("lit-noChange"), _ = Symbol.for("lit-nothing"), Ce = /* @__PURE__ */ new WeakMap(), P = T.createTreeWalker(T, 129);
function Ie(s, e) {
...
const Ke = (s, e) => {
  ...
  let i, r = e === 2 ? "<svg>" : e === 3 ? "<math>" : "", n = V;
  for (let d = 0; d < t; d++) {
    const a = s[d];
    let h, u, c = -1, f = 0;
    for (; f < a.length && (n.lastIndex = f, u = n.exec(a), u !== null); ) f = n.lastIndex, n === V ? u[1] === "!--" ? n = we : u[1] !== void 0 ? n = Se : u[2] !== void 0 ? (Te.test(u[2]) && (i = RegExp("</" + u[2], "g")), n = O) : u[3] !== void 0 && (n = O) : n === O ? u[0] === ">" ? (n = i ?? V, c = -1) : u[1] === void 0 ? c = -2 : (c = n.lastIndex - u[2].length, h = u[1], n = u[3] === void 0 ? O : u[3] === '"' ? ke : Ae) : n === ke || n === Ae ? n = O : n === we || n === Se ? n = V : (n = O, i = void 0);
    const v = n === O && s[d + 1].startsWith("/>") ? " " : "";
    r += n === V ? a + Ve : c >= 0 ? (o.push(h), a.slice(0, c) + Pe + a.slice(c) + k + v) : a + k + (c === -2 ? d : v);
  }
  return [Ie(s, r + (s[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), o];
};
class X {
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    this.parts = [];
    let r = 0, n = 0;
    const d = e.length - 1, a = this.parts, [h, u] = Ke(e, t);
    if (this.el = X.createElement(h, o), P.currentNode = this.el.content, t === 2 || t === 3) {
    ...
    for (; (i = P.nextNode()) !== null && a.length < d; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const c of i.getAttributeNames()) if (c.endsWith(Pe)) {
          const f = u[n++], v = i.getAttribute(c).split(k), $ = /([.?@])?(.*)/.exec(f);
          a.push({ type: 1, index: r, name: $[2], strings: v, ctor: $[1] === "." ? Xe : $[1] === "?" ? Ye : $[1] === "@" ? Qe : oe }), i.removeAttribute(c);
        } else c.startsWith(k) && (a.push({ type: 6, index: r }), i.removeAttribute(c));
        if (Te.test(i.tagName)) {
          const c = i.textContent.split(k), f = c.length - 1;
          if (f > 0) {
            i.textContent = ie ? ie.emptyScript : "";
            for (let v = 0; v < f; v++) i.append(c[v], K()), P.nextNode(), a.push({ type: 2, index: ++r });
            i.append(c[f], K());
          }
        }
        ...
        let c = -1;
        for (; (c = i.data.indexOf(k, c + 1)) !== -1; ) a.push({ type: 7, index: r }), c += k.length - 1;
      }
      r++;
    }
  }
...
function H(s, e, t = s, o) {
  ...
  return (i == null ? void 0 : i.constructor) !== r && ((d = i == null ? void 0 : i._$AO) == null || d.call(i, !1), r === void 0 ? i = void 0 : (i = new r(s), i._$AT(s, t, o)), o !== void 0 ? (t._$Co ?? (t._$Co = []))[o] = i : t._$Cl = i), i !== void 0 && (e = H(s, i._$AS(s, e.values), i, o)), e;
}
class Ge {
  constructor(e, t) {
  ...
  u(e) {
    ...
    P.currentNode = i;
    let r = P.nextNode(), n = 0, d = 0, a = o[0];
    for (; a !== void 0; ) {
      if (n === a.index) {
        let h;
        a.type === 2 ? h = new Y(r, r.nextSibling, this, e) : a.type === 1 ? h = new a.ctor(r, a.name, a.strings, this, e) : a.type === 6 && (h = new et(r, this, e)), this._$AV.push(h), a = o[++d];
      }
...
class Y {
  ...
  constructor(e, t, o, i) {
    this.type = 2, this._$AH = _, this._$AN = void 0, this._$AA = e, this._$AB = t, this._$AM = o, this.options = i, this._$Cv = (i == null ? void 0 : i.isConnected) ?? !0;
  }
  get parentNode() {
  ...
  _$AI(e, t = this) {
    e = H(this, e, t), G(e) ? e === _ || e == null || e === "" ? (this._$AH !== _ && this._$AR(), this._$AH = _) : e !== this._$AH && e !== j && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Fe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== _ && G(this._$AH) ? this._$AA.nextSibling.data = e : this.T(T.createTextNode(e)), this._$AH = e;
  }
  $(e) {
    var r;
    const { values: t, _$litType$: o } = e, i = typeof o == "number" ? this._$AC(e) : (o.el === void 0 && (o.el = X.createElement(Ie(o.h, o.h[0]), this.options)), o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i) this._$AH.p(t);
    else {
      const n = new Ge(i, this), d = n.u(this.options);
  ...
  k(e) {
    ...
    const t = this._$AH;
    let o, i = 0;
    for (const r of e) i === t.length ? t.push(o = new Y(this.O(K()), this.O(K()), this, this.options)) : o = t[i], o._$AI(r), i++;
...
class oe {
  ...
  constructor(e, t, o, i, r) {
    this.type = 1, this._$AH = _, this._$AN = void 0, this.element = e, this.name = t, this._$AM = i, this.options = r, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = _;
  }
  _$AI(e, t = this, o, i) {
    const r = this.strings;
    let n = !1;
    if (r === void 0) e = H(this, e, t, 0), n = !G(e) || e !== this._$AH && e !== j, n && (this._$AH = e);
    else {
      const d = e;
      let a, h;
      for (e = r[0], a = 0; a < r.length - 1; a++) h = H(this, d[o + a], t, a), h === j && (h = this._$AH[a]), n || (n = !G(h) || h !== this._$AH[a]), h === _ ? e = _ : e !== _ && (e += (h ?? "") + r[a + 1]), this._$AH[a] = h;
    }
    n && !i && this.j(e);
  }
  j(e) {
...
class Qe extends oe {
  ...
  _$AI(e, t = this) {
    ...
    const o = this._$AH, i = e === _ && o !== _ || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive, r = e !== _ && (o === _ || i);
...
pe == null || pe(X, Y), (J.litHtmlVersions ?? (J.litHtmlVersions = [])).push("3.3.1");
const tt = (s, e, t) => {
...
var Ee;
x._$litElement$ = !0, x.finalized = !0, (Ee = D.litElementHydrateSupport) == null || Ee.call(D, { LitElement: x });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const it = { attribute: !0, type: String, converter: te, reflect: !1, hasChanged: ge }, st = (s = it, e, t) => {
...
function m(s) {
  return (e, t) => typeof t == "object" ? st(s, e, t) : ((o, i, r) => {
...
var ot = Object.defineProperty, rt = Object.getOwnPropertyDescriptor, w = (s, e, t, o) => {
...
w([
  m({ attribute: !1 })
], b.prototype, "preselected", 2);
w([
  p()
], b.prototype, "_name", 2);
w([
  p()
], b.prototype, "_temperatureSensor", 2);
w([
  p()
], b.prototype, "_heaters", 2);
w([
  p()
], b.prototype, "_coolers", 2);
w([
  p()
], b.prototype, "_windowSensors", 2);
w([
  p()
], b.prototype, "_roomType", 2);
b = w([
  z("adopt-dialog")
], b);
var nt = Object.defineProperty, at = Object.getOwnPropertyDescriptor, R = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? at(e, t) : e, r = s.length - 1, n; r >= 0; r--)
    (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
R([
  p()
], E.prototype, "_devices", 2);
R([
  p()
], E.prototype, "_loading", 2);
R([
  p()
], E.prototype, "_dialogOpen", 2);
R([
  p()
], E.prototype, "_selectedEntity", 2);
E = R([
  z("setup-view")
], E);
var lt = Object.defineProperty, dt = Object.getOwnPropertyDescriptor, re = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? dt(e, t) : e, r = s.length - 1, n; r >= 0; r--)
    (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
let L = class extends x {
  ...
  render() {
    ...
    const e = ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], t = (/* @__PURE__ */ new Date()).toLocaleDateString("en-US", { weekday: "short" }).toLowerCase();
    return l`
      <div class="card">
        <h2>Timeline</h2>
  ...
  _renderBlocks(s, e) {
    ...
    if (n.sort(
      (a, h) => a.start_time.localeCompare(h.start_time)
    ), (n.length > 0 ? n[0].start_time : "24:00") > "00:00") {
      const a = ["mon", "tue", "wed", "thu", "fri", "sat", "sun"], h = a.indexOf(e);
      let u = null;
      for (let c = 1; c <= 7; c++) {
        const f = (h - c + 7) % 7, v = a[f], $ = t.filter(
          (Z) => Z.days.includes(v)
        );
        if ($.length > 0) {
          $.sort(
            (Z, ne) => Z.start_time.localeCompare(ne.start_time)
          ), u = $[$.length - 1];
          break;
        }
      }
    ...
    return n.map((a, h) => {
      const [u, c] = a.start_time.split(":").map(Number), f = u * 60 + c;
      let v = 1440;
      if (h < n.length - 1) {
        const W = n[h + 1], [Ue, Me] = W.start_time.split(":").map(Number);
        v = Ue * 60 + Me;
      }
      const $ = v - f, Z = f / 1440 * 100, ne = $ / 1440 * 100;
      let N = "";
      const Q = a.temp_heat ?? a.target_temp, ae = a.temp_cool ?? a.target_temp, le = 16, de = 24;
      let q = 1;
      if (r === "heat") {
        N = `${Q}°`;
        const W = (Q - le) / (de - le);
        ...
        const W = (de - ae) / (de - le);
        q = 0.4 + 0.6 * Math.min(Math.max(W, 0), 1);
      } else r === "auto" ? (N = `${Q}-${ae}°`, q = 0.9) : (N = `${Q}°`, q = 0.5);
      return l`
        <div
          class="schedule-block mode-${r}"
          style="left: ${Z}%; width: ${ne}%; opacity: ${q.toFixed(
        2
      )};"
...
re([
  m()
], L.prototype, "focusZoneId", 2);
re([
  p()
], L.prototype, "_selectedDay", 2);
L = re([
  z("timeline-view")
], L);
var ct = Object.defineProperty, ht = Object.getOwnPropertyDescriptor, ze = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? ht(e, t) : e, r = s.length - 1, n; r >= 0; r--)
    (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
var pt = Object.defineProperty, ut = Object.getOwnPropertyDescriptor, y = (s, e, t, o) => {
...
let g = class extends x {
  constructor() {
    super(...arguments), this.allEntities = [], this._uniqueId = "", this._name = "", this._temperatureSensor = "", this._heaters = /* @__PURE__ */ new Set(), this._coolers = /* @__PURE__ */ new Set(), this._windowSensors = /* @__PURE__ */ new Set(), this._restoreDelayMinutes = 0, this._loading = !1, this._error = "";
  }
  async firstUpdated() {
...
y([
  m({ attribute: !1 })
], g.prototype, "zoneId", 2);
y([
  m({ attribute: !1 })
], g.prototype, "allEntities", 2);
y([
  p()
], g.prototype, "_uniqueId", 2);
y([
  p()
], g.prototype, "_name", 2);
y([
  p()
], g.prototype, "_temperatureSensor", 2);
y([
  p()
], g.prototype, "_heaters", 2);
y([
  p()
], g.prototype, "_coolers", 2);
y([
  p()
], g.prototype, "_windowSensors", 2);
y([
  p()
], g.prototype, "_restoreDelayMinutes", 2);
y([
  p()
...
var _t = Object.defineProperty, mt = Object.getOwnPropertyDescriptor, U = (s, e, t, o) => {
...
var ft = Object.defineProperty, vt = Object.getOwnPropertyDescriptor, M = (s, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? vt(e, t) : e, r = s.length - 1, n; r >= 0; r--)
    (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
