...
const Be = (s) => new De(typeof s == "string" ? s : s + "", void 0, ge),
  M = (s, ...e) => {
    const t =
      s.length === 1
        ? s[0]
...
const {
  ...
  E = globalThis,
  xe = E.trustedTypes,
  Ve = xe ? xe.emptyScript : "",
  pe = E.reactiveElementPolyfillSupport,
  K = (s, e) => s,
  oe = {
    toAttribute(s, e) {
      switch (e) {
...
(Symbol.metadata ?? (Symbol.metadata = Symbol("metadata")),
  E.litPropertyMetadata ??
    (E.litPropertyMetadata = /* @__PURE__ */ new WeakMap()));
let H = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, o) {
    const { get: i, set: r } = Re(this.prototype, e) ?? {
      get() {
        return this[t];
      },
      set(n) {
  ...
  static finalize() {
    ...
    if (
      ((this.finalized = !0), this._$Ei(), this.hasOwnProperty(K("properties")))
    ) {
...
((H.elementStyles = []),
  ...
  (H[K("elementProperties")] = /* @__PURE__ */ new Map()),
  (H[K("finalized")] = /* @__PURE__ */ new Map()),
  pe == null || pe({ ReactiveElement: H }),
  (E.reactiveElementVersions ?? (E.reactiveElementVersions = [])).push(
    "2.1.1",
  ));
/**
 * @license
...
const G = globalThis,
  re = G.trustedTypes,
  Se = re ? re.createPolicy("lit-html", { createHTML: (s) => s }) : void 0,
  Te = "$lit$",
  ...
  z = document,
  X = () => z.createComment(""),
  Y = (s) => s === null || (typeof s != "object" && typeof s != "function"),
  be = Array.isArray,
  Je = (s) =>
    be(s) || typeof (s == null ? void 0 : s[Symbol.iterator]) == "function",
  ue = `[ 	
\f\r]`,
  J = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  Ae = /-->/g,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  T = z.createTreeWalker(z, 129);
function Me(s, e) {
  if (!be(s) || !s.hasOwnProperty("raw"))
...
const Ge = (s, e) => {
  ...
  for (let d = 0; d < t; d++) {
    ...
    let h,
      ...
      c = -1,
      g = 0;
    for (; g < a.length && ((n.lastIndex = g), (u = n.exec(a)), u !== null); )
      ((g = n.lastIndex),
        n === J
          ? u[1] === "!--"
            ? (n = Ae)
            : u[1] !== void 0
              ? (n = ke)
              : u[2] !== void 0
                ? (ze.test(u[2]) && (i = RegExp("</" + u[2], "g")), (n = D))
                : u[3] !== void 0 && (n = D)
          : n === D
            ? u[0] === ">"
              ? ((n = i ?? J), (c = -1))
    ...
    r +=
      n === J
        ? a + Fe
        : c >= 0
          ? (o.push(h), a.slice(0, c) + Te + a.slice(c) + C + v)
          : a + C + (c === -2 ? d : v);
  }
  return [
    Me(
  ...
  constructor({ strings: e, _$litType$: t }, o) {
    ...
    for (; (i = T.nextNode()) !== null && a.length < d; ) {
      if (i.nodeType === 1) {
        ...
        if (i.data === Ie) a.push({ type: 2, index: r });
        else {
          let c = -1;
          for (; (c = i.data.indexOf(C, c + 1)) !== -1; )
...
function R(s, e, t = s, o) {
  ...
  return (
    ...
    i !== void 0 && (e = R(s, i._$AS(s, e.values), i, o)),
    e
  );
}
class Xe {
  ...
  u(e) {
    const {
      ...
      i = ((e == null ? void 0 : e.creationScope) ?? z).importNode(t, !0);
    T.currentNode = i;
    let r = T.nextNode(),
      n = 0,
      d = 0,
    ...
    for (; a !== void 0; ) {
      if (n === a.index) {
        let h;
        (a.type === 2
          ? (h = new ee(r, r.nextSibling, this, e))
          : a.type === 1
            ? (h = new a.ctor(r, a.name, a.strings, this, e))
            : a.type === 6 && (h = new tt(r, this, e)),
          this._$AV.push(h),
          (a = o[++d]));
      }
...
class ee {
    ...
    const { values: t, _$litType$: o } = e,
      i =
        typeof o == "number"
          ? this._$AC(e)
          : (o.el === void 0 &&
              (o.el = Q.createElement(Me(o.h, o.h[0]), this.options)),
            o);
    if (((r = this._$AH) == null ? void 0 : r._$AD) === i) this._$AH.p(t);
    else {
      const n = new Xe(i, this),
        d = n.u(this.options);
  ...
  k(e) {
    ...
    for (const r of e)
      (i === t.length
        ? t.push((o = new ee(this.O(X()), this.O(X()), this, this.options)))
        : (o = t[i]),
        o._$AI(r),
        i++);
...
(_e == null || _e(Q, ee),
  (G.litHtmlVersions ?? (G.litHtmlVersions = [])).push("3.3.1"));
const it = (s, e, t) => {
...
class x extends H {
  ...
  update(e) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(e),
      (this._$Do = it(t, this.renderRoot, this.renderOptions)));
  }
  connectedCallback() {
    var e;
...
((x._$litElement$ = !0),
  (x.finalized = !0),
  (Oe = I.litElementHydrateSupport) == null || Oe.call(I, { LitElement: x }));
...
var rt = Object.defineProperty,
  ...
  w = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? nt(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
...
b = w([U("adopt-dialog")], b);
var at = Object.defineProperty,
  lt = Object.getOwnPropertyDescriptor,
  q = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? lt(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
P.styles = M`
  ...
  `;
q([m({ attribute: !1 })], P.prototype, "hass", 2);
q([p()], P.prototype, "_devices", 2);
q([p()], P.prototype, "_loading", 2);
q([p()], P.prototype, "_dialogOpen", 2);
q([p()], P.prototype, "_selectedEntity", 2);
P = q([U("setup-view")], P);
var dt = Object.defineProperty,
  ct = Object.getOwnPropertyDescriptor,
  le = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? ct(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
  ...
  _renderBlocks(s, e) {
    ...
    if (
      ...
      for (let c = 1; c <= 7; c++) {
        const g = (h - c + 7) % 7,
          v = a[g],
          $ = t.filter((W) => W.days.includes(v));
        if ($.length > 0) {
          ($.sort((W, de) => W.start_time.localeCompare(de.start_time)),
            (u = $[$.length - 1]));
          break;
        }
      }
    ...
    return n.map((a, h) => {
      ...
      if (h < n.length - 1) {
        const O = n[h + 1],
          [ce, he] = O.start_time.split(":").map(Number);
        v = ce * 60 + he;
      }
      const $ = v - g,
        W = (g / 1440) * 100,
        de = ($ / 1440) * 100;
      let j = "";
      const V = a.temp_heat ?? a.target_temp,
        te = a.temp_cool ?? a.target_temp,
        k = 16,
        ie = 24;
      let F = 1;
      if (r === "heat") {
        ...
        j = `${V}-${te}°`;
        const O = (V - k) / (ie - k),
          ce = 0.4 + 0.6 * Math.min(Math.max(O, 0), 1),
          he = (te - k) / (ie - k),
          Ne = 0.4 + 0.6 * Math.min(Math.max(he, 0), 1);
        F = Math.max(ce, Ne);
      } else ((j = `${V}°`), (F = 0.5));
      return l`
        <div
          class="schedule-block mode-${r}"
          style="left: ${W}%; width: ${de}%; --block-opacity: ${F.toFixed(2)};"
...
Z.styles = M`
  ...
  `;
le([m({ attribute: !1 })], Z.prototype, "hass", 2);
le([m()], Z.prototype, "focusZoneId", 2);
le([p()], Z.prototype, "_selectedDay", 2);
Z = le([U("timeline-view")], Z);
var ht = Object.defineProperty,
  pt = Object.getOwnPropertyDescriptor,
  Ue = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? pt(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
ne.styles = M`
  ...
  `;
Ue([m({ attribute: !1 })], ne.prototype, "hass", 2);
ne = Ue([U("zones-view")], ne);
var ut = Object.defineProperty,
  _t = Object.getOwnPropertyDescriptor,
  y = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? _t(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
f.styles = M`
  ...
  `;
y([m({ attribute: !1 })], f.prototype, "hass", 2);
y([m({ attribute: !1 })], f.prototype, "zoneId", 2);
y([m({ attribute: !1 })], f.prototype, "allEntities", 2);
y([p()], f.prototype, "_uniqueId", 2);
y([p()], f.prototype, "_name", 2);
y([p()], f.prototype, "_temperatureSensor", 2);
y([p()], f.prototype, "_heaters", 2);
y([p()], f.prototype, "_coolers", 2);
y([p()], f.prototype, "_windowSensors", 2);
y([p()], f.prototype, "_restoreDelayMinutes", 2);
y([p()], f.prototype, "_loading", 2);
y([p()], f.prototype, "_error", 2);
f = y([U("zone-editor")], f);
var mt = Object.defineProperty,
  ft = Object.getOwnPropertyDescriptor,
  N = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? ft(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
S.styles = M`
  ...
  `;
N([m({ attribute: !1 })], S.prototype, "hass", 2);
N([m({ attribute: !1 })], S.prototype, "zoneId", 2);
N([p()], S.prototype, "_schedule", 2);
N([p()], S.prototype, "_loading", 2);
N([p()], S.prototype, "_uniqueId", 2);
N([p()], S.prototype, "_config", 2);
S = N([U("schedule-editor")], S);
var vt = Object.defineProperty,
  bt = Object.getOwnPropertyDescriptor,
  B = (s, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? bt(e, t) : e, r = s.length - 1, n;
      r >= 0;
      r--
    )
      (n = s[r]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
A.styles = M`
  ...
  `;
B([m({ attribute: !1 })], A.prototype, "hass", 2);
B([m({ attribute: !1 })], A.prototype, "narrow", 2);
B([m({ attribute: !1 })], A.prototype, "panel", 2);
B([p()], A.prototype, "_view", 2);
B([p()], A.prototype, "_editingZoneId", 2);
B([p()], A.prototype, "_unmanagedCount", 2);
A = B([U("climate-dashboard")], A);
console.info(
